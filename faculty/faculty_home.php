  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <!-- Divider -->
        <li class="nav-item">
        <a class="nav-link collapsed" href="faculty_student_table.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="faculty_attendence_table.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="faculty_assessment_table.php">
          <i class="fas fa-chalkboard-teacher px-3"></i>
          <span>Assesment</span>
        </a>
        ...
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
		 ...
		 <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="faculty_student_leave_table.php">New Applications</a>
            <a class="collapse-item" href="faculty_student_pending_leave.php">Pending Applications</a>
            <a class="collapse-item border-top" href="faculty_new_leave.php">Apply Leave</a>
            </div>
        </div>	
      </li>
		...
		<!-- Sidebar Toggle (Topbar) -->
		 ...
		 <!-- Topbar Navbar -->
          ...
          <!-- Nav Item - Alerts -->
			...
			<li class="nav-item">
               <a class="nav-link " href="faculty_profile.php">  <!-- $var passed into faculty profile page-->
