	...
	<!------------------starts first section----------------------->
		...
		<section>
			...
			<div class="container ">
					...
					<!--start form section-->
						<form method="post" action="php_faculty_new_leave.php" class="">
								...
								<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="form_reason">Faculty id</label>
												<input id="form_reason" type="text" name="fid" class="form-control" required="required"></input>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="form_reason">Faculty name</label>
												<input id="form_reason" type="text" name="fname" class="form-control" required="required"></input>
